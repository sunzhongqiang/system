...
/**
* RecommendPositionServiceImpl: 位置表 业务服务层实现
* 2016-11-14 13:56:04
* @author huguangling 胡广玲
* @version 1.0
*/
@Service
public class RecommendPositionServiceImpl extends BaseServiceImpl<RecommendPosition, Long> implements RecommendPositionService {
