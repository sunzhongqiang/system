...
public class GoodsGroupDaoImpl extends SpringDataQueryDaoImpl<GoodsGroup> implements GoodsGroupDao {
	...
	public Page<GoodsGroup> findRecommend(String code, Pageable pageable) {
		StringBuffer sb = new StringBuffer(
				"select model from RecommendPosition position , RecommendGroup recommendGroup, GoodsGroup model left join fetch model.goods   where position.id = recommendGroup.positionId and  model.id =  recommendGroup.goodId ");
		Map<String, Object> params = new HashMap<String, Object>();
