...
*/
@Repository
public class RecommendPositionDaoImpl extends SpringDataQueryDaoImpl<RecommendPosition> implements RecommendPositionDao {
    ...
    public Page< Map<String,Object>> listBySql(RecommendPositionCondition condition,Pageable pageable){
        StringBuffer sb=new StringBuffer("select id,position_name,code from business_recommend_position  where 1=1  ");
