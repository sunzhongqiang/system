...
public class WxAppAuthDaoImpl extends SpringDataQueryDaoImpl<WxAppAuth> implements WxAppAuthDao {
	...
	public Page<Map<String, Object>> listBySql(WxAppAuthCondition condition, Pageable pageable) {
		StringBuffer sb = new StringBuffer(
				"select id,authorizer_appid,authorizer_access_token,authorizer_refresh_token,expires_in,modified,nick_name,head_img,user_name,principal_name,alias,business_info,qrcode_url,func_info,authorization_info from wx_app_auth  where 1=1  ");
