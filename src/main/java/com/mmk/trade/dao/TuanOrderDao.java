/*
 * 
 *  TuanOrderDao 创建于 2016-11-05 13:27:33 版权归作者和作者当前组织所有
 */
...
public interface TuanOrderDao extends SpringDataQueryDao<TuanOrder>{
     ...
     * 
     */
    Page<TuanOrder> list(TuanOrderCondition tuanOrder,Pageable pageable);
    /**
     ...
     * 
     */
    List<TuanOrder> list(TuanOrderCondition tuanOrder);
    /**
     * 使用sql查询，并以map和分页的形式进行返回数据结果
     * @param tuanOrder TuanOrder类
     * @param pageable 传入的分页对象
     * @return 符合条件的查询结果集
     * @author huguangling 胡广玲
     * 
     * 
     */
    Page<Map<String,Object>> listBySql(TuanOrderCondition tuanOrder,Pageable pageable);
    /**
