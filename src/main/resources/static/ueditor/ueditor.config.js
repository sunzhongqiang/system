...
//        ,webRootPath:appWebRoot				//****自定义配置 网站根目录
        ...
        ,savePath: [ 'image','advert']    //图片保存在服务器端的目录， 默认为空， 此时在上传图片时会向服务器请求保存图片的目录列表，
        ,maxSize:15                                                    // 如果用户不希望发送请求， 则可以在这里设置与服务器端能够对应上的目录名称列表
                                                            //比如： savePath: [ 'upload1', 'upload2' ]
//        ,savePathUrl:appWebRoot+"/type/list.do" //**** 自定义配置 远程获取上传目录列表,不使用savePath
//
//        //涂鸦图片配置区
...
//
//        //图片在线管理配置区
//        ,imageManagerUrl:appWebRoot + "/ueditor/imageManager.do"       //图片在线管理的处理地址
...
//
//        //word转存配置区
//        ,wordImageUrl:appWebRoot+"/ueditor/wordImage/add.do"            //word转存提交地址
//        ,wordImagePath:""                          //
